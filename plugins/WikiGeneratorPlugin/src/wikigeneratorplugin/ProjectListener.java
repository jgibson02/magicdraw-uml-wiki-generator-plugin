        ...
        if (dialogResponse == JOptionPane.YES_OPTION) {
            ...
            if (fXmlFile.exists()) {
                try {
                    ...
                    this.spSiteURL = doc.getElementsByTagName("url").item(0)
                            .getTextContent();
                ...
                */
                ...
                Application.getInstance().getGUILog().showError("No " +
                        "project config found for this project, please go" +
                        " to Tools -> SharePoint Plugin Options and " +
                        "configure options before continuing");
            }
        }
    }
